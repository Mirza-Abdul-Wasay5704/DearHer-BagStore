// components/WhatsAppCTA.tsx — WhatsApp call-to-action section
      ...
      <div className="mx-auto max-w-3xl px-4 text-center">
        ...
        <a
          href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
            "Hi! I'd like help choosing a bag from Dear Her 🎀"
          )}`}
          target="_blank"
          rel="noopener noreferrer"
          className="mt-8 inline-flex items-center gap-3 rounded-sm bg-green-600 px-8 py-4 text-xs font-medium uppercase tracking-[0.2em] text-white transition-all hover:bg-green-700"
        >
          <svg
