      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 md:grid-cols-2 md:gap-20">
          ...
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden rounded-sm bg-beige-200">
              <div className="flex h-full items-center justify-center bg-gradient-to-br from-beige-100 to-beige-200">
                <div className="text-center">
                  ...
                  <p className="mt-4 font-serif text-lg text-beige-400">
                    Dear Her
                  </p>
                </div>
              </div>
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-6 -right-6 -z-10 h-full w-full rounded-sm border border-brand-primary/20" />
          </div>
          ...
          <div>
            ...
            <div className="mt-10 grid grid-cols-3 gap-6 border-t border-beige-200 pt-8">
              <div>
                <p className="font-serif text-2xl text-brand-primary">100%</p>
                <p className="mt-1 text-[11px] uppercase tracking-wider text-beige-500">
                  Handpicked
                </p>
              </div>
              <div>
                <p className="font-serif text-2xl text-brand-primary">500+</p>
                <p className="mt-1 text-[11px] uppercase tracking-wider text-beige-500">
                  Happy Customers
                </p>
              </div>
              <div>
                <p className="font-serif text-2xl text-brand-primary">50+</p>
                <p className="mt-1 text-[11px] uppercase tracking-wider text-beige-500">
                  Unique Prints
                </p>
              </div>
